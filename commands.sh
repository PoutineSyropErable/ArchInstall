...
pacstrap -K /mnt base linux linux-firmware btrfs-progs iwd dhcpcd grub efibootmgr sudo i3-wm kitty fish tmux lf neovim firefox networkmanager sddm xclip maim scrot
...
#if can't install stuff due to keys
...
#not needed after adding grub and it through pacstrap 
